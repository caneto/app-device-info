...
/// A tela de detalhes para a tela A ou B.
...
class DetailsScreenState extends State<DetailsScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Tela de detalhes - ${widget.label}'),
      ),
      body: Center(
        child: Column(
          mainAxisSize: MainAxisSize.min,
          children: <Widget>[
            Text('Detalhes para ${widget.label} - Contador: $_counter',
                style: Theme.of(context).textTheme.titleLarge),
            const Padding(padding: EdgeInsets.all(4)),
            TextButton(
              onPressed: () {
              ...
              child: const Text('Incrementa o Contador'),
            ),
          ],
        ),
      ),
